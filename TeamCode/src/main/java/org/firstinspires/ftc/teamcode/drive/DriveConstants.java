...
public class DriveConstants {
    ...
    private static final MotorConfigurationType MOTOR_CONFIG = MotorConfigurationType.getMotorType(GoBILDA5202Series.class);
     ...
     */
    public static double WHEEL_RADIUS = 2;   // Radius of a 4" wheel:    radius = (diameter /2 )
